...
│   ├── icon.tsx            # → /icon — generated favicon (next/og, brand star)
│   ├── apple-icon.tsx      # → /apple-icon — generated Apple touch icon
│   ├── opengraph-image.tsx # → /opengraph-image — generated OG share card
│   ├── twitter-image.tsx   # → /twitter-image — re-exports the OG card
│   └── manifest.ts         # → /manifest.webmanifest — generated PWA manifest
│
...
│   ├── brand.ts            # Brand-mark geometry + palette (generated icons/OG)
...
> `public/assets/showreel/`, `public/assets/grid-images/`. Reference them by
> absolute path (`/assets/showreel/star.svg`). There are **no** meta/PWA/SEO
> binaries at the `public/` root — favicons, icons, OG and the manifest are all
> generated from the brand mark (see [[seo-metadata]]).
...
| A favicon / icon / OG / manifest asset | Generated — edit `lib/brand.ts` + the `app/*-image`/`icon` routes |
