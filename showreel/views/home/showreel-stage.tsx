...
import { useShowreelLayout } from "@/showreel/hooks/use-showreel-layout";
import { ProgressTrigger } from "@/showreel/components/animation/springs/progress-trigger";
import { FlameBackground } from "@/showreel/components/3d/flame-background";
import { TargetStar } from "@/showreel/components/3d/target-star";
import { HeroCard } from "@/showreel/views/home/hero-card";
import { CatalistCard } from "@/showreel/views/home/catalist-card";
import { SphereCard } from "@/showreel/views/home/sphere-card";
import { Marquee } from "@/showreel/views/home/marquee";
import { Portfolio } from "@/showreel/views/home/portfolio";
import { CtaBlock } from "@/showreel/views/home/cta-block";
import type { ShowreelContent } from "@/showreel/data/mocks/home";
import {
  GRID_ITEMS,
  card1Width,
  card1Height,
...
} from "@/showreel/utils/showreel/timeline";
              ...
              >
                ...
                >
                  <HeroCard
                    ...
                    images={{ stone: `${A}/cosmic-hero.webp`, rotated: `${A}/cosmic-services.jpg` }}
                    active={vis.hero}
                  />
                </animated.div>
                ...
                >
                  <CatalistCard variant="dark" content={content.catalistDark} bg={`${A}/cosmic-card-dark.jpg`} />
                </animated.div>
                ...
                >
                  <CatalistCard variant="light" content={content.catalistLight} bg={`${A}/cosmic-card-light.jpg`} />
                </animated.div>
