      ...
      <div style={{ background: "#1a1a1a" }}>
        <div className="site-wrap" style={{ padding: "64px 24px" }}>
          <div style={{ display: "grid", gap: "40px" }} className="md:grid-cols-2 lg:grid-cols-4">
            ...
            {/* Col 1 */}
            <div>
              <Image src="/brandingo-logo.png" alt="Brandingo" width={180} height={45} style={{ height: "40px", width: "auto", objectFit: "contain", marginBottom: "16px", filter: "brightness(0) invert(1)" }} />
